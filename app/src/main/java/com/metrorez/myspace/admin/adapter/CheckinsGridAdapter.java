...
public class CheckinsGridAdapter extends RecyclerView.Adapter<CheckinsGridAdapter.ViewHolder> implements Filterable {
    ...
    private DatabaseReference moveInReference = FirebaseDatabase.getInstance().getReference().child("moveIns");
        ...
        moveInReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                    for (DataSnapshot moveInSnapShot : userSnapshot.getChildren()) {
